                    ...
                    <div class="flex space-x-4">
                        ...
                        @auth
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                {{-- <button class="dark:text-white">{{ __('Logout') }}</button> --}}
                                <a href="{{ route('login') }}"
                                    class="lg:px-3 py-2 text-sm font-medium rounded-md hover:text-sky-600 dark:hover:text-white text-sky-600 dark:text-white text-slate-400"
